...
public class PaymentTest {
    ...
    void createPrepared() {
        ...
        Assertions.assertThat(payment.getValidUntil()).isAfter(LocalDateTime.now(clock));
    ...
    void isValid() {
        ...
        Assertions.assertThat(payment.isValidClock(clock)).isTrue();
        Assertions.assertThat(
                        payment.isValidClock(
